...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption(option =>
      option.setName('link')
        .setDescription('Video link (YouTube Shorts, TikTok, or Instagram)')
        .setRequired(true))
    .addAttachmentOption(option =>
      option.setName('analytics')
        .setDescription('Analytics screenshot (required for Instagram)')
        .setRequired(false)),
  ...
  async execute(interaction) {
    ...
    try {
      ...
      if (validation.platform === 'Instagram' && !analyticsProof) {
        return await interaction.editReply({
          embeds: [errorEmbed('Analytics Required', 'Instagram submissions require an analytics screenshot!')]
        });
      }
